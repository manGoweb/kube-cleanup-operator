...
import (
	...
	"github.com/manGoweb/kube-cleanup-operator/pkg/controller"
...
func main() {
	...
	keepFailedHours := flag.Int("keep-failures", -1, "Number of hours to keep failed jobs, -1 - forever (default) 0 - never, >0 number of hours")
